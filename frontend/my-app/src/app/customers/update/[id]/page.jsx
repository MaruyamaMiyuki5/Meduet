...
export default function UpdatePage(props) {
  ...
  const previous_pregnant = customerInfo.pregnant
  const previous_prefecture = customerInfo.prefecture
  const previous_allergy = customerInfo.allergy
  const previous_height = customerInfo.height
  const previous_weight = customerInfo.weight
