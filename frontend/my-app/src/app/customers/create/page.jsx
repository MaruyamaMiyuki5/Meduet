                ...
                <div className="m-4 card bordered bg-blue-200 duration-200 hover:border-r-red">
                    <form ref={formRef} onSubmit={handleSubmit}>
                        <div className="card-body">
                            ...
                            <p>Pregnant:<input type="text" name="pregnant" placeholder="いいえ" className="input input-bordered" /></p>
                            <p>prefecture:<input type="text" name="prefecture" placeholder="いいえ" className="input input-bordered" /></p>
                            <p>allergy:<input type="text" name="allergy" placeholder="いいえ" className="input input-bordered" /></p>
                            <p>height:<input type="text" name="height" placeholder="いいえ" className="input input-bordered" /></p>
                            <p>weight:<input type="text" name="weight" placeholder="いいえ" className="input input-bordered" /></p>
                        </div>
